...
<div class="table-responsive">
	<form action="updateUser.do?uid=${u.uid }" method="post">
		<table class="table table-bordered  table-hover table-striped">
			<tr style="background-color: rgba(100, 149, 237, 0.3)">
				<th colspan="2"><h5 style="text-align: center">修改用户</h5></th>
			</tr>
			<tr>
				<td class="info">昵称</td>
				<td><input type="text" name="uname" id="uname"
					value="${u.uname}" readonly="readonly" />
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="text" name="ustatus" value="${u.ustatus}" /></td>
			</tr>
			<tr>
				<td class="info">激活码</td>
				<td><input type="text" name="ucode" value="${u.ucode}" /></td>
			</tr>
			<tr>
...
$(function(){
	...
	$("#sub").click(function(){ //验证 
		return checkPassword() && checkUphone() && checkUemail() && checkUstatus();
	});
	//离开焦点时 
