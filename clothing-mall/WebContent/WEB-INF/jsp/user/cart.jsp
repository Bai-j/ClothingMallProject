                                ...
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="pro-quantity">加购数量</th>
                                            <th class="pro-subtotal">商品总价</th>
                                            <th class="pro-remove">结算</th>
                                            <th class="pro-remove">删除购物车</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                      ...
                                      <form action="toOrder.do" method="post">
                                        <tr>
                                            ...
                                            <td class="pro-price"><span><input type="text" value="${c.gprice }" name="gprice" style="width:55px; border: none;outline: none" readonly="readonly" /></span><span>元</span></td>
                                            <td class="pro-quantity">
                                            	<input value="${c.gid }" class="my_id" style="display:none" name="gid"/>
                                            	<input value="${c.gname }" style="display:none" name="gname"/>
                                                <div class="pro-qty"><input type="text" value="${c.gnum }" class="textNum" name="gnum" /></div>
                                            </td>
                                            <td class="pro-subtotal"><span>${c.gnum * c.gprice }元</span></td>
                                            <td><input type="submit" class="btn btn-sqr d-block" id="order" value="去结算"></td>
                                            <td class="pro-remove"><a href="toDeleteCart.do?uid=${sessionScope.user.uid }&gid=${c.gid }"><i class="fa fa-trash-o"></i></a></td>
                                        </tr>
                                      </form>
                                      </c:forEach>
                                    </tbody>
