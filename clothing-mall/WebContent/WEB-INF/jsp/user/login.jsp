                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="login-reg-form-wrap">
                                <h4>登录</h4>
                                <form action="doUserLogin.do" method="post">
                                    <div class="single-input-item">
                                        <input type="text" name="uname" id="uname" placeholder="请输入用户名" required />
                                    </div>
                                    <div class="single-input-item">
                                        <input type="password" name="upassword" id="upassword" placeholder="请输入密码" required />
                                    </div>
                                    <div class="single-input-item">
                                    ...
                                    <div class="single-input-item">
                                        <button class="btn btn-sqr">登录</button>
                                    </div>
                                </form>
                                <div align="center">
