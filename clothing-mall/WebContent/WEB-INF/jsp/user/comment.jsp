                        ...
                        <div class="breadcrumb-wrap">
                            <nav aria-label="breadcrumb">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">评价</li>
                                </ul>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="order-summary-details">
                            <h4 class="checkout-title">你的评价</h4>
                            <div class="order-summary-content">
                                <!-- Order Summary Table -->
                                <form action="doComment.do" method="post">
                                ...
                                <div class="order-payment-method">
                                    <div class="single-input-item">
                                        <label for="ordernote">商品评价</label>
                                        <textarea name="comment" cols="30" rows="3" placeholder="如果满意可以对商品进行一下评价，如不满意也可以提出意见及建议~"></textarea>
                                    </div>
                                    <div class="summary-footer-area">
                                        <button type="submit" class="btn btn-sqr">提交评价</button>
                                    </div>
                                </div>
                                </form>
                            </div>
